...
| Метод                     | Параметр                        | Shares, ETF | Bonds                                | <nobr>Futures</nobr>|
|:---------------------------|:---------------------------------|:-------------|:--------------------------------------| :---|
...
Формула для пересчета пунктов в валюту: **price** / 100 * **nominal**.
...
Формула для пересчета: **price** / **min_price_increment** * **min_price_increment_amount**.