...
class SubscribeLastPriceResponse extends \Google\Protobuf\Internal\Message
{
     ...
     */
    private $last_price_subscriptions;
     ...
     *          Уникальный идентификатор запроса. [Подробнее](./grpc#tracking-id).
     *     @type \Tinkoff\Invest\V1\LastPriceSubscription[] $last_price_subscriptions
     *          Массив статусов подписки на цену последней сделки.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .tinkoff.public.invest.api.contract.v1.LastPriceSubscription last_price_subscriptions = 2;</code>
     * @return RepeatedField<\Tinkoff\Invest\V1\LastPriceSubscription>
     */
    public function getLastPriceSubscriptions()
    {
        return $this->last_price_subscriptions;
    }
     ...
     *
     * Generated from protobuf field <code>repeated .tinkoff.public.invest.api.contract.v1.LastPriceSubscription last_price_subscriptions = 2;</code>
     * @param \Tinkoff\Invest\V1\LastPriceSubscription[] $var
     * @return $this
     */
    public function setLastPriceSubscriptions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Tinkoff\Invest\V1\LastPriceSubscription::class);
        $this->last_price_subscriptions = $arr;
